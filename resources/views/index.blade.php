    ...
    <div class="row">
      <div class="col-lg-4 mb-5">
        ...
        <article class="card">
          ...
          <div class="card-body">
            <h3 class="h4 mb-3"><a class="post-title" href="{{route('blog-details',string_to_slug("{$editors_pick[0]->title} {$editors_pick[0]->id}",'-'))}}">{{$editors_pick[0]->title}}</a></h3>
            ...
            <a href="{{route('blog-details',string_to_slug("{$editors_pick[0]->title} {$editors_pick[0]->id}",'-'))}}" class="btn btn-outline-primary">Read More</a>
          </div>
        </article>
      </div>
      <div class="col-lg-4 mb-5">
        ...
        <article class="card mb-4">
          <div class="card-body d-flex">
            ...
            <div class="ml-3">
              <h4><a href="{{route('blog-details',string_to_slug("$item->title $item->id",'-'))}}" class="post-title">{{$item->title}}</a></h4>
      ...
      <div class="col-lg-4 mb-5">
        ...
        <article class="card mb-4">
            ...
            <div class="card-body">
              <h3 class="h4 mb-3"><a class="post-title" href="{{route('blog-details',string_to_slug("$post->title $post->id",'-'))}}">{{ucwords($post->title)}}</a></h3>
              <ul class="card-meta list-inline">
                <li class="list-inline-item">
              ...
              <a href="{{route('blog-details',string_to_slug("$post->title $post->id",'-'))}}" class="btn btn-outline-primary">Read More</a>
            </div>
          </article>
      </div>
      <div class="col-12">
