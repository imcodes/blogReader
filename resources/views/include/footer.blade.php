    ...
    <div class="container">
        ...
        <div class="col-md-5 text-center text-md-left mb-4">
            <ul class="list-inline footer-list mb-0">
              ...
              <li class="list-inline-item"><a href="{{route('term-and-conditions')}}">Terms Conditions</a></li>
            </ul>
        </div>
        <div class="col-md-2 text-center mb-4">
            <a href="index.html"><img class="img-fluid" width="100px" src="{{asset("images/logo.png")}}" alt="Reader | Hugo Personal Blog Template"></a>
        </div>
