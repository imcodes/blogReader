      ...
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="content pl-lg-3 pl-0">
            <h2 id="helllo-im-richi-andorn-im-a-biography-based-researcher-and-author">Helllo I’m Richi Andorn I’m a Biography Based researcher And Author</h2>
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-5 col-md-6 order-2 order-md-1 text-center text-md-left">
          ...
          <a href="https://www.youtube.com/channel/UCx9qVW8VF0LmTi4OF2F8YdA" class="btn btn-primary">Visit Channel</a>
        </div>
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
          <div class="video-wrapper">
            ...
            data-src="https://www.youtube.com/embed/dyZcRRWiuuw" data-target="#myModal" href="#"><i class="ti-control-play"></i></a>
          </div>
        </div>
      </div>
    </div>
